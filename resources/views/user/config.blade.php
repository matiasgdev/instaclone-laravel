      ...
      <div class="col-md-8">
        ...
        <div class="card">
          <div class="card-header">
            <h3 style="margin: 0;"> Configuración de mi cuenta </h3>
          </div>
          ...
          <div class="card-body">
            <form method="POST" action=" {{ route('user.update') }} " enctype="multipart/form-data">
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input id="image_path" type="file" class="form-control-file @error('image_path') is-invalid @enderror" name="image_path"  autocomplete="email">
